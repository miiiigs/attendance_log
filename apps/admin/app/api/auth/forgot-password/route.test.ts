...
describe("POST /api/auth/forgot-password", () => {
  ...
  beforeEach(() => {
    ...
    getOptionalAppBaseUrl.mockReturnValue("https://scppa-portal.vercel.app");
  ...
  async function post(payload: Record<string, unknown>) {
    ...
    return POST(
      new Request("https://scppa-portal.vercel.app/api/auth/forgot-password", {
        method: "POST",
  ...
  it("returns a generic success response", async () => {
    ...
    expect(resetPasswordForEmail).toHaveBeenCalledWith("owner@example.com", {
      redirectTo: "https://scppa-portal.vercel.app/reset-password",
    });
  });
