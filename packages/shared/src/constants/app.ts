...
export const ACTIVITY_VISIBILITIES = ["community_only", "anyone_with_code"] as const;
export const ORGANIZATION_JOIN_AUTHORIZATION_STATUSES = ["pending", "claimed", "revoked"] as const;
